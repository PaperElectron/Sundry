...
var serverOpts = {};
serverOpts.sslPort = NODE_ENV ? env.sundry_prod_ssl_port : env.sundry_dev_ssl_port;
serverOpts.port = NODE_ENV ? env.sundry_prod_non_ssl_port : env.sundry_dev_non_ssl_port;
